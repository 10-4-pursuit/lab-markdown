...
This assumption, based on morphological comparisons of fossils, conflicts with a 2006 genetic analysis which indicates raccoons are more closely related to ringtails. 
...
[A picture of a playful raccoon](https://curiodyssey.org/wp-content/uploads/2014/03/relaxingracoonblog.jpg)
...
```js
console.log("Racoons are like pigeons without wings")
```